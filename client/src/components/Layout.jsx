...
const Icons = {
  ...
  listings: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V9l-7-5-7 5v12h4v-7h6v7h4z" /></svg>,
...
const navItems = [
  ...
  { path: '/listings', label: 'Listings', icon: Icons.listings },
